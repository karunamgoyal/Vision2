...
public class addInstitute extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mdatabadereference = FirebaseDatabase.getInstance().getReference().child("institute");
        ...
        publish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Institutes study = new Institutes(name1, tag1, desc1, url1);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.add_institute, menu);
        return true;
    }
